...
| `OPS_TALK_ROOM` | Fleet briefs, `@openclaw` ops chat | `@openclaw` required |
| OpenClaw 1:1 DM | Direct chat | Any |

## Proposal replies (mandatory routing)

Family Hub messages matching `@openclaw YES|NO|EDIT enrich-*|ask-*`:
...
See [OPENCLAW-STACK.md](OPENCLAW-STACK.md) and [plans/openclaw_talk_response_fix.md](plans/openclaw_talk_response_fix.md).
